...
consent transaction. Specifically recording the key policy links [HF: what kind of links?] Links that contain the legally required policy information. These Are: 
1. Privacy Policy
2. Terms Of Service
3. Cookie Policy
(any other policy that governs consent)
